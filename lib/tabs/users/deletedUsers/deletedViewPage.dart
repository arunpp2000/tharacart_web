...
class DeletedUsersViewWidget extends StatefulWidget {
  final String? id;
  const DeletedUsersViewWidget({Key? key, this.id}) : super(key: key);

  @override
  _DeletedUsersViewWidgetState createState() => _DeletedUsersViewWidgetState();
}

class _DeletedUsersViewWidgetState extends State<DeletedUsersViewWidget> {
