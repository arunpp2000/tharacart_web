...
class B2bDialogue extends StatefulWidget {


  const B2bDialogue({Key? key})
      : super(key: key);

  @override
  _B2bDialogueState createState() => _B2bDialogueState();
}

class _B2bDialogueState extends State<B2bDialogue> {
