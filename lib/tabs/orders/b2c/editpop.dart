...
class AddressPopUp extends StatefulWidget {
  ...
  const AddressPopUp({Key? key, this.name, this.address, this.landMark, this.area, this.state, this.pincode, this.orderId, this.customerId, this.city}) : super(key: key);
